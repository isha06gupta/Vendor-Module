// Sample Data for all projects (simulate backend)
const projectData = {
  "Order-101": {
    dashboard: {
      "Name": "Ravi Kumar",
...
window.addEventListener('DOMContentLoaded', function() {
  const username = sessionStorage.getItem("username") || "isha06gupta";
...
companyProfileNav.addEventListener('click', function (e) {
  e.preventDefault();
  resetActiveNav();
...
projectInfoNav.addEventListener('click', function (e) {
  e.preventDefault();
  resetActiveNav();
...
docUploadNav.addEventListener('click', function (e) {
  e.preventDefault();
  resetActiveNav();
...
submissionHistoryNav.addEventListener('click', function (e) {
  e.preventDefault();
  resetActiveNav();
...
queriesResponsesNav.addEventListener('click', function (e) {
  e.preventDefault();
  resetActiveNav();
